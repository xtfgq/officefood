...
public class SplashTestActivity extends SupportActivity {
...
//        }, 3000);
    ...
    public void onViewClicked() {
        if(editPhone.getText().toString().startsWith("http")) {

            Constants.HOST = editPhone.getText().toString();
            startActivity(new Intent(SplashTestActivity.this,
                    MainActivity.class));
            finish();
        }
